...
export { idlFactory } from './canisterfund.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CANISTERFUND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./canisterfund.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the canisterfund canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./canisterfund.did.js")._SERVICE>}
 */
export const canisterfund = createActor(canisterId);
